...
import com.cs.sis_sdk.ble.bluetooth.BleBluetooth;
import com.cs.sis_sdk.ble.conn.BleCharacterCallback;
import com.cs.sis_sdk.ble.conn.BleGattCallback;
import com.cs.sis_sdk.ble.data.ScanResult;
import com.cs.sis_sdk.ble.exception.BleException;
import com.cs.sis_sdk.ble.exception.hanlder.DefaultBleExceptionHandler;
import com.cs.sis_sdk.ble.scan.ListScanCallback;
import com.cs.sis_sdk.ble.utils.BleLog;


public class SgBleManager {
  ...
  private static  SgBleManager INSTANCE;

  private SgBleManager(Context context) {
  ...
  public static final SgBleManager getInstance(Context context) {
    if(null==INSTANCE){
      INSTANCE=new SgBleManager(context);
    }
    return INSTANCE;
  }
